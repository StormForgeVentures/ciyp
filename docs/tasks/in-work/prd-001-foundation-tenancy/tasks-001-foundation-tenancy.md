...
- [ ] 2.0 Contract freeze — six contracts as zod in `@stormforgeventures/ciyp-shared`, published (maps to: 001a FR-5..8 / AC-001-foundation-tenancy-02, -08..-10) — **2.1/2.2 done; 2.3 BLOCKED external (see note)**
