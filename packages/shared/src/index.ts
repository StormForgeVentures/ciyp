/**
 * @stormforgeventures/ciyp-shared — the published surface (contract 06).
 * Consumed by ciyp-template (exact-pinned from the private registry) and by this engine
 * (workspace:*). The UI imports ONLY this package + @stormforgeventures/ciyp-ui-tokens — never agents/prompts.
 */
